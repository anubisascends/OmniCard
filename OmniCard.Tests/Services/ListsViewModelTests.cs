...
public class ListsViewModelTests
{
    ...
    private sealed class FakeDialogService : IDialogService
    {
        ...
        public BinderAuditChoice PromptBinderAuditMode(string locationName) => throw new NotImplementedException();
        public bool ShowBinderImportAudit(int containerId, IReadOnlyList<CollectionCard> importedCards) => throw new NotImplementedException();
        ...
        public AuditSourceChoice PromptAuditSource(string locationName) => throw new NotImplementedException();
