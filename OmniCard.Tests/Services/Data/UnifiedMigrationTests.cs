...
namespace OmniCard.Tests.Services.Data;
...
public class UnifiedMigrationTests : IDisposable
{
    ...
    public void EnsureUnifiedSchema_AddsMissingTablesAndColumns_ToPhase1OnlyInventoryDb()
    {
        ...
        foreach (var table in new[] { "StorageContainers", "EbayListings", "MismatchLogs", "FlagResolutions", "ScanDiagnosticEvents", "MigrationState", "Listings", "Customers", "Orders", "OrderLines", "OrderEdits" })
        {
        ...
        foreach (var (table, column) in new[] { ("Products", "SetName"), ("Products", "Color"), ("Products", "CardType"), ("Products", "LastMarketPrice"), ("Products", "PriceUpdatedAt"), ("Lots", "IsMissing"), ("Lots", "FlagReason"), ("Listings", "Channel"), ("Listings", "Status"), ("Listings", "ListedPrice"), ("Orders", "Status"), ("Orders", "MarketplaceFees"), ("Orders", "ShippedAt"), ("Orders", "ImportedItemCount"), ("Orders", "ImportedProductValue"), ("Movements", "OrderLineId") })
        {
