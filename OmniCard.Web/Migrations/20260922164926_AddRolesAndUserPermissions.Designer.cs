...
namespace OmniCard.Web.Migrations
{
    ...
    [Migration("20260922164926_AddRolesAndUserPermissions")]
    partial class AddRolesAndUserPermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OmniCard.Shared.Settings.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmniCard.Shared.Settings.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmniCard.Shared.Storage.DeckType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("BasicLandsExempt")
                        .HasColumnType("bit");

                    b.Property<string>("BuiltInKey")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("CommanderSlots")
                        .HasColumnType("int");

                    b.Property<bool>("CopiesCountByCollectorNumber")
                        .HasColumnType("bit");

                    b.Property<int?>("DeckSizeMax")
                        .HasColumnType("int");

                    b.Property<int?>("DeckSizeMin")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MaxCopiesPerCard")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmniCard.Shared.Storage.StorageContainer", b =>
                {
                    b.HasOne("OmniCard.Shared.Storage.DeckType", null)
                        .WithMany()
                        .HasForeignKey("DeckTypeId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
